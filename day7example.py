...
#             tList.pop(o)
#             for g in tList:
#                 availableSteps.append(g)
#             replaceFinishedJobs(stepDict, firstInAlphabet)
#             completedSteps.append(firstInAlphabet)
...
#     letterCheck = []
#     keyList = []
#     with open("values7orig.txt") as steps:
